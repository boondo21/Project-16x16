...
public class ScrollBarVertical extends PClass {
	...
	public void display() {
		...
		// DisplayLocationBar
		applet.fill(100);
		barAnchor.setLocalY((int) PApplet.map(getBarLocation(), 0, 1, 0, container.Height() - barAnchor.getLocalHeight()));
	...
	public float getBarLocation() {
		return barLocation;
	}

	public void setBarLocation(float barLocation) {
